...
public class DoadorService {
	...
	public Page<Object> findAllPaged(PageRequest pageRequest) {
		Page<Usuario> list = repository.findAll(pageRequest);// chamando a busca paginada do reporitory
	...
	public DoadorDTO update(Long idDoador, DoadorDTO dto) {
		Usuario entity = repository.getOne(idDoador);// para pegar apenas 1x do BD
		try {
			//entity.setNome(dto.getIdDoador());
